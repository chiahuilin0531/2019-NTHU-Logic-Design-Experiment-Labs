...
# set_property PACKAGE_PIN E19 [get_ports {mode0}]
#     set_property IOSTANDARD LVCMOS33 [get_ports {mode0}]
# set_property PACKAGE_PIN U19 [get_ports {mode_1}]
#     set_property IOSTANDARD LVCMOS33 [get_ports {mode_1}]
# set_property PACKAGE_PIN V19 [get_ports {mode2}]
